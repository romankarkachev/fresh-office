...
<div class="responsible-by-project-types-form">
    ...
    <div class="row">
        <div class="col-md-2">
            <?= $form->field($model, 'project_type_id')->widget(Select2::className(), [
                'data' => DirectMSSQLQueries::arrayMapOfProjectsTypesForSelect2(DirectMSSQLQueries::PROJECTS_TYPES_FOR_RESPONSIBLE),
    ...
    <?= $form->field($model, 'receivers')->textarea(['rows' => 3, 'placeholder' => 'Один почтовый ящик на строку']) ?>
