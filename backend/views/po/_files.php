            ...
            'columns' => [
                [
                    ...
                    'value' => function ($model, $key, $index, $column) {
                        /** @var $model \common\models\PoFiles */
                ...
                [
                    ...
                    'value' => function ($model, $key, $index, $column) {
                        ...
                        return Html::a(
                            ...
                            ['/' . PoController::ROOT_URL_FOR_SORT_PAGING . '/' . PoController::URL_DOWNLOAD_FILE, 'id' => $model->id],
                            [
                        ...
                        'delete' => function ($url, $model) {
                            ...
                            if ($model->po->state_id == PaymentOrdersStates::PAYMENT_STATE_ЧЕРНОВИК || Yii::$app->user->can('root'))
                                return Html::a('<i class="fa fa-trash-o"></i>', [
                                    '/' . PoController::ROOT_URL_FOR_SORT_PAGING . '/' . PoController::URL_DELETE_FILE,
                                    'id' => $model->id
                                ], [
...
<?php
$url = Url::to(PoController::URL_PREVIEW_FILE_AS_ARRAY);
