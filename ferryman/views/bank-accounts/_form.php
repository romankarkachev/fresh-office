...
<div class="bank-accounts-form">
    ...
    <div class="card">
        ...
        <div class="card-footer text-muted">
            <?= Html::a('<i class="fa fa-arrow-left" aria-hidden="true"></i> Банковские счета', ['/bank-accounts'], ['class' => 'btn btn-lg', 'title' => 'Вернуться в список. Изменения не будут сохранены']) ?>
...
<?php
$url_inn_ogrn = Yii::$app->backendUrlManager->createUrl(['/services/fetch-counteragents-info-dadata']);
$url_bank_bik = Yii::$app->backendUrlManager->createUrl(['/services/fetch-bank-by-bik']);
