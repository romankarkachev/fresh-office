...
/* @var $searchModel common\models\PackingTypesSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Виды упаковки | ' . Yii::$app->name;
$this->params['breadcrumbs'][] = 'Виды упаковки';
?>
<div class="packing-types-list">
    <p>
