...
/**
 * PoEigController implements the CRUD actions for PoEig model.
 */
class PoEigController extends Controller
{
    /**
     ...
     */
    const ROOT_URL_FOR_SORT_PAGING = 'po-eig';
     ...
     */
    const ROOT_LABEL = 'Группы статей расходов';
    ...
    /**
     * Lists all PoEig models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new PoEigSearch();
    ...
    /**
     * Updates an existing PoEig model.
    ...
    /**
     * Deletes an existing PoEig model.
    ...
    /**
     * Finds the PoEig model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return PoEig the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = PoEig::findOne($id)) !== null) {
            return $model;
        }
