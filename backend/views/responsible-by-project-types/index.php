...
/* @var $searchModel common\models\ResponsibleByProjectTypesSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Ответственные по типам проектов | ' . Yii::$app->name;
$this->params['breadcrumbs'][] = 'Ответственные по типам проектов';
?>
<div class="responsible-by-project-types-list">
    <p>
