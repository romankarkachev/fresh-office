...
/**
 * This is the model class for table "eco_projects_milestones_files".
 *
 * @property integer $id
 * @property integer $uploaded_at
 * @property integer $uploaded_by
 * @property integer $project_milestone_id
 * @property string $ffp
 * @property string $fn
 * @property string $ofn
 * @property integer $size
 *
 * @property EcoProjectsMilestones $projectMilestone
 * @property User $uploadedBy
 */
class EcoProjectsMilestonesFiles extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'eco_projects_milestones_files';
    }
    ...
    {
        return [
            [['project_milestone_id', 'ffp', 'fn', 'ofn'], 'required'],
            [['uploaded_at', 'uploaded_by', 'project_milestone_id', 'size'], 'integer'],
            [['ffp', 'fn', 'ofn'], 'string', 'max' => 255],
            [['project_milestone_id'], 'exist', 'skipOnError' => true, 'targetClass' => EcoProjectsMilestones::className(), 'targetAttribute' => ['project_milestone_id' => 'id']],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'project_milestone_id' => 'Этап проекта по экологии',
    ...
    {
        $filepath = Yii::getAlias('@uploads-eco-projects-fs');
        if (!is_dir($filepath)) {
    ...
    {
        return $this->hasOne(EcoProjectsMilestones::className(), ['id' => 'project_milestone_id']);
    }
