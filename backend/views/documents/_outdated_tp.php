...
if (result.src_unit != "") $("#documentstp-src_unit-" + result.counter).val(result.src_unit);
if (result.src_dc != "") $("#documentstp-src_dc-" + result.counter).val(result.src_dc);
...
return result.text;
        ...
        <div class="col-md-1">
            <div class="form-group field-documents-src_unit">
                <label class="control-label" for="documents-src_unit">Ед. изм.</label>
                <?= Html::input('text', 'Documents[tp]['.$counter.'][src_unit]', $model->product ? $model->product->src_unit : null, ['class' => 'form-control input-sm', 'readonly' => true, 'id' => 'documentstp-src_unit-'.$counter]) ?>
