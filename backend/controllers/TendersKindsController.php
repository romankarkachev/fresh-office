...
use common\models\TendersKindsSearch;
...
/**
 * TendersKindsController implements the CRUD actions for TendersKinds model.
 */
class TendersKindsController extends Controller
{
    /**
     ...
     */
    const ROOT_URL_FOR_SORT_PAGING = 'tenders-kinds';
     ...
     */
    const ROOT_LABEL = 'Разновидности конкурсов';
    ...
    /**
     * Lists all TendersKinds models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new TendersKindsSearch();
    ...
    /**
     * Creates a new TendersKinds model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new TendersKinds();
    ...
    /**
     * Updates an existing TendersKinds model.
    ...
    /**
     * Deletes an existing TendersKinds model.
    ...
    /**
     * Finds the TendersKinds model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return TendersKinds the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = TendersKinds::findOne($id)) !== null) {
            return $model;
        }
