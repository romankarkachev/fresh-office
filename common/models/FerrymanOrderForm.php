...
class FerrymanOrderForm extends Model
{
     ...
     */
    const DEFAULT_VALUE_SPECIAL_CONDITIONS = 'На погрузке и выгрузке водитель должен быть в закрытой одежде и закрытой обуви (в случае несоблюдения данного пункта - штраф 2000 (две тысячи) руб.). Машина должна  быть опломбирована после погрузки. На выгрузке не будет печати, только подпись ответственного лица.';
