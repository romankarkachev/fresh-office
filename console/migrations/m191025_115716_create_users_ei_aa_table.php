...
/**
 * Создается таблица "Статьи, доступные для согласования бухгалтерам по бюджету".
 */
class m191025_115716_create_users_ei_aa_table extends Migration
{
    /**
     * @var string наименование таблицы, которая создается
     */
    const TABLE_NAME = 'users_ei_aa';
    ...
    public function safeUp()
    {
        ...
        if ($this->db->driverName === 'mysql') {
            $tableOptions = 'CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE=InnoDB COMMENT "Доступ бухгалтеров по бюджету к согласованию статей расходов без руководства"';
        };
