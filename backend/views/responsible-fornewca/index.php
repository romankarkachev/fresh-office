...
/* @var $searchModel common\models\ResponsibleFornewcaSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Ответственные лица для создания новых контрагентов | ' . Yii::$app->name;
$this->params['breadcrumbs'][] = 'Ответственные лица для создания новых контрагентов';
?>
<div class="responsible-fornewca-list">
    <p>
