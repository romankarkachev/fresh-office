...
<div class="cp-bl-contact-emails-form">
    ...
    <div class="form-group">
        <?= Html::a('<i class="fa fa-arrow-left" aria-hidden="true"></i> Исключенные E-mail', ['/block-list-contact-emails'], ['class' => 'btn btn-default btn-lg', 'title' => 'Вернуться в список. Изменения не будут сохранены']) ?>
