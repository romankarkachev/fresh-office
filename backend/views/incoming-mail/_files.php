...
<div class="files-list">
    <div class="table-responsive">
        ...
        <?= GridView::widget([
            ...
            'showOnEmpty' => false,
            'emptyText' => '<div class="well well-small">Файлы не прикреплялись.</div>',
            'layout' => '{items}',
            ...
            'columns' => [
                [
                    ...
                    'value' => function ($model, $key, $index, $column) {
                        /** @var $model \common\models\IncomingMailFiles */
                ...
                [
                    ...
                    'value' => function ($model, $key, $index, $column) {
                        ...
                        return Html::a(
                            ...
                            ['/' . IncomingMailController::URL_ROOT_FOR_SORT_PAGING . '/' . IncomingMailController::URL_DOWNLOAD_FILE, 'id' => $model->id],
                            [
                    ...
                    'buttons' => [
                        'delete' => function ($url, $model) {
                            ...
                            return Html::a('<i class="fa fa-trash-o"></i>', [
                                '/' . IncomingMailController::URL_ROOT_FOR_SORT_PAGING . '/' . IncomingMailController::URL_DELETE_FILE,
                                'id' => $model->id
                            ], [
...
<?php
$url = Url::to(IncomingMailController::URL_PREVIEW_FILE_AS_ARRAY);
